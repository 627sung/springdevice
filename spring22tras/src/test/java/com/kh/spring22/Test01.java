...
public class Test01 {
	...
	public void test() {
		...
		ProductDto productDto = ProductDto.builder().product_no(2).product_name("포카칩").category_no(3).build();
		
		sqlSession.insert("test.a",categoryDto);
		sqlSession.insert("test.b",productDto);
